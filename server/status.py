...
def get_status(cursor: int = 0) -> dict:
    ...
    Response shape:
    {
        ...
        "current_tool_args": "{\"path\": \"/some/file\"}",
        "last_activity_ts": "2026-02-18 21:16:46.537",
        "last_message_from": "telegram:317794218|ElChiang",
        "stats": {
            "tool_calls": 42,
            "messages_in": 10,
            "messages_out": 8,
        ...
        "logs": [ ... incremental entries ... ],
        "cursor": 157
    }
    """
    # Collect logs after the given cursor
